...
function makeStyles(theme: any) { return StyleSheet.create({
  ...
  locationChip: { minWidth: 118, minHeight: 40, maxHeight: 40, flexShrink: 0, alignSelf: "center", alignItems: "center", justifyContent: "center", paddingHorizontal: 14, paddingVertical: 6, borderRadius: 999, borderWidth: 1, borderColor: theme.color.border, backgroundColor: "transparent" },
  ...
  locationChipText: { color: theme.color.onSurface, fontWeight: "600", fontSize: 13, lineHeight: 18, textAlign: "center", textAlignVertical: "center", includeFontPadding: false },
