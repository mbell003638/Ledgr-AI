  ...
  return (
    <View style={{ minWidth: compact ? 0 : 60, width: compact ? "100%" : undefined, flexShrink: 1, paddingHorizontal: compact ? 1 : 0, alignItems: "center", justifyContent: "center" }}>
      <Text
        ...
        style={{ color, maxWidth: "100%", flexShrink: 1, fontSize: compact ? 9.5 : 11, lineHeight: compact ? 13 : 14, fontWeight: "700", letterSpacing: compact ? 0 : 0.1, includeFontPadding: false, textAlign: "center", overflow: "hidden" }}
      >
        {children}
      </Text>
      <View
