      ...
      >
        {loading && !dash ? (
          ...
          <>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: theme.spacing.lg, marginBottom: theme.spacing.md }}>
              ...
              {isEditingGrid ? (
                <Pressable
                  ...
                  style={{ backgroundColor: theme.color.brandPrimary, paddingHorizontal: 12, paddingVertical: 5, borderRadius: 16 }}
                >
            ...
            {/* Re-order & Auto-Sort Floating Toolbar (only visible during 3-second long-press mode) */}
            {isEditingGrid ? (
