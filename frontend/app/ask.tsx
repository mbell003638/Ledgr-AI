...
import { isExplicitBookMutationRequest, isNeutralTranscript } from "@/src/db/ai";
...
function makeStyles(theme: any) {
  return StyleSheet.create({
    ...
    askVoiceInline: { flex: 1, minWidth: 0, minHeight: 62, flexDirection: "row", alignItems: "center", overflow: "visible", paddingHorizontal: 10, paddingVertical: 5, borderRadius: 18, borderWidth: 1, borderColor: theme.color.brandPrimary + "55", backgroundColor: theme.color.brandPrimary + "08" },
    askVoiceControls: { width: 92, minHeight: 50, alignItems: "center", justifyContent: "center", flexShrink: 0 },
    askVoiceOrbButton: { width: 86, height: 46, justifyContent: "center", alignItems: "center", flexShrink: 0 },
    askVoiceOrbButtonDisabled: { opacity: 0.75 },
    askVoiceAction: { marginTop: -2, fontSize: 9, lineHeight: 11, fontWeight: "700", color: theme.color.brandPrimary },
    askVoiceCopy: { flex: 1, minWidth: 0, marginLeft: 4 },
    askVoiceStatus: { fontSize: 14, lineHeight: 17, fontWeight: "800" },
    askVoiceHint: { fontSize: 12, lineHeight: 15, marginTop: 2 },
    askVoiceSetupLink: { alignSelf: "flex-start", marginTop: 3, paddingVertical: 2 },
    askVoiceSetupText: { fontSize: 12, lineHeight: 15, fontWeight: "800", color: theme.color.brandPrimary },
    askVoiceStop: { width: 36, height: 36, borderRadius: 18, borderWidth: 1, borderColor: theme.color.border, backgroundColor: "transparent", justifyContent: "center", alignItems: "center", marginLeft: 8 },
  });
}
