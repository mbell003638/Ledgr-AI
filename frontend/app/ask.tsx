...
function makeStyles(theme: any) {
  return StyleSheet.create({
    ...
    askVoiceInline: { flex: 1, minWidth: 0, minHeight: 48, flexDirection: "row", alignItems: "center", overflow: "visible" },
    askVoiceControls: { width: 96, minHeight: 44, alignItems: "center", justifyContent: "center", flexShrink: 0 },
    askVoiceOrbButton: { width: 92, height: 44, justifyContent: "center", alignItems: "center", flexShrink: 0 },
