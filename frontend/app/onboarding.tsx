        ...
        {step === 2 && (
          <View style={styles.stepBody}>
            ...
            <View style={styles.currencyGrid}>
              {CURRENCIES.map((value) => <Pressable key={value} onPress={() => setCurrency(value)} style={[styles.currencyButton, currency === value && styles.currencySelected]} accessibilityRole="radio" accessibilityLabel={`Currency ${value}`} accessibilityState={{ selected: currency === value }}><Text style={[styles.currencyText, currency === value && { color: theme.color.brandPrimary }]}>{value}</Text></Pressable>)}
            </View>
          </View>
        )}
...
function makeStyles(theme: any) {
  return StyleSheet.create({
    ...
    currencyButton: { minWidth: 74, minHeight: 44, paddingHorizontal: 15, paddingVertical: 10, borderRadius: 14, borderWidth: 1, borderColor: theme.color.border, backgroundColor: theme.color.surfaceSecondary, alignItems: "center", justifyContent: "center" },
    ...
    toggleHitArea: { minWidth: 50, minHeight: 44, alignItems: "center", justifyContent: "center" },
