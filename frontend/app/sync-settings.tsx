...
import { parseSyncSetupQr } from '@/src/sync/setupQr';
...
export default function SyncSettingsScreen() {
  ...
  const [scanning, setScanning] = useState(false); const [scanLocked, setScanLocked] = useState(false);
