...
export async function getAIConfig(): Promise<AIConfig> {
  const [provider, secureKey, storedKey, model, visionModel, transcriptionModel, transcriptionBaseUrl, secureTranscriptionKey, baseUrl, voiceProvider] = await Promise.all([
