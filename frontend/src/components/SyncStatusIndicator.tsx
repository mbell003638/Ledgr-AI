...
const styles = StyleSheet.create({ pill: { position: 'absolute', right: 12, zIndex: 20, flexDirection: 'row', alignItems: 'center', gap: 5, borderWidth: 1, borderRadius: 999, paddingHorizontal: 9, paddingVertical: 6, ...(Platform.OS === 'web' ? { boxShadow: '0 2px 10px rgba(0,0,0,0.12)' } : { elevation: 6 }) }, text: { fontSize: 11, fontWeight: '800' } });
