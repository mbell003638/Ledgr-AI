...
export function defaultAccounts(bookId: string): V2Account[] {
  const defs: [string, string, V2AccountType][] = [
    ...
    ['2100', 'Customer Advances', 'liability'], ['2200', 'Commission Payable', 'liability'], ['2500', 'Other Liabilities', 'liability'], ['3000', 'Capital Accounts', 'equity'], ['3100', 'Capital Withdrawals', 'equity'], ['3200', 'Current Profit', 'equity'], ['3300', 'Retained Earnings', 'equity'], ['3400', 'Owner Contributions', 'equity'],
