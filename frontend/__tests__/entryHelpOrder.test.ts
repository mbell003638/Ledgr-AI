...
describe('entry help order and spoken names', () => {
  ...
  it('keeps OCR and voice on device when interpretation is on-device', () => {
    const cfg = { interpretationProvider: 'android-device' as const, ocrProvider: 'cloud' as const, voiceProvider: 'cloud' as const };
